    ...
    return (
        ...
        >
            ...
            >
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-3 relative group">
                                <label
                                    htmlFor="name"
                                    className="text-[10px] uppercase tracking-[0.3em] opacity-40 group-focus-within:opacity-100 transition-opacity"
                                >
                                    Name
                                </label>
                            ...
                            <button
                                ...
                                className="group relative w-full py-6 border border-white/20 rounded-full overflow-hidden transition-all hover:border-white/60 disabled:opacity-50"
                            >
                ...
                <motion.div
                    variants={fadeUp}
                    className="mt-20 md:mt-24 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between gap-4 opacity-30 text-[10px] uppercase tracking-[0.2em]"
                >
                    <p>
            ...
            <AnimatePresence>
                {status === 'success' && (
                    ...
                    >
                        ...
                        >
                            {/* Accent Circle */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-white/5 rounded-full blur-2xl" />
